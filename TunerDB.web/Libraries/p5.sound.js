...
audioin = function () {
  ...
  p5.AudioIn = function () {
    ...
    if (typeof window.MediaDevices === 'undefined') {
      window.alert('This browser does not support MediaDevices');
    } else if (typeof window.MediaDevices.getSources === 'function') {
  ...
  p5.AudioIn.prototype.start = function (successCallback, errorCallback) {
    ...
    if (p5sound.inputSources[self.currentSource]) {
      ...
      navigator.getUserMedia({ 'audio': true }, this._onStream = function (stream) {
        self.stream = stream;
        self.enabled = true;
        // Wrap a MediaStreamSourceNode around the live input
        self.mediaStream = p5sound.audiocontext.createMediaStreamSource(stream);
  ...
  p5.AudioIn.prototype.listSources = function () {
    ...
    if (p5sound.inputSources.length > 0) {
      ...
      return 'This browser does not support MediaDevices.getSources()';
    }
  };
  /**
  ...
  p5.AudioIn.prototype.getSources = function (callback) {
    if (typeof window.MediaDevices.getSources === 'function') {
      window.MediaDevices.getSources(function (data) {
      ...
      console.log('This browser does not support MediaDevices.getSources()');
    }
  };
  /**
